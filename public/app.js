    ...
    return `
      <section class="panel mdef">
        ...
        <label class="field">
          ...
          <span class="field-hint mb0">שעות החילופים של המשימה, מופרדות ברווח.
            להצגה בלבד — לא יוצאות התראות על משמרת שלא דיווחה.</span>
        </label>
...
/* Handovers that came and went with nobody filing anything used to be counted
   here and raised as a notice on opening the console. The office does not
   want to be told any more — not by WhatsApp and not by the screen — so the
   count, the notice and the acknowledging that went with it are gone.

   The reports themselves are untouched: they are still filed, still read here
   and still searchable. What has gone is being chased about them. */
